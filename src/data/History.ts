...
export const MyHistory: ResumeSection[]=[
    ...
    { id: 3, title:'Section 3', contents:[
        ...
        { type: ContentType.Column, data:'', desc:'', length : 0, child: [ 
            { type: ContentType.Bar, data:'English', desc:'', length : 80, child: null, style: null },
            { type: ContentType.Bar, data:'C#', desc:'', length : 85, child: null, style: null }
        ], style: null }
    ]}
]